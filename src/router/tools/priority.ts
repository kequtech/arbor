...
interface SortableUrl {
    url: string;
}

export function priorityUrl(a: SortableUrl, b: SortableUrl): number {
...
interface SortableContentType {
    contentType: string;
}

export function priorityContentType(a: SortableContentType, b: SortableContentType): number {
